...
class autoMFIS():
    ...
    \n - lag: Max. lags.
    '''
    def __init__(self,diff_series=False,detrend_series=False,fuzzy_method='mfdef_triangle',solve_method='None',defuzz_method='mom', 
                 num_groups = 5, inputs = 10,h_prev = 1, num_series = 1, max_rulesize = 5, min_activation = 0.5, lag = 1, 
                 target_position = -1, hide_values = False, form_method = 'nmean', show=False, split_method = 'FCD'):
